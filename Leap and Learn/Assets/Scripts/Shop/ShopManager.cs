...
public class ShopManager : MonoBehaviour
{
    ...
    public void LoadDicts(Action callback)
    {
        if (PlayFabController.Instance != null)
        {
            PlayFabController.Instance.GetPlayerSkinData((skins) =>
            {
                playerFrogsDict = skins;
                PlayFabController.Instance.GetPlayerHatsData((hats) =>
                {
                    playerHatsDict = hats;
                    Debug.Log($"Got {playerFrogsDict.Count} skins and {playerHatsDict.Count} hats.");
                    ProccessDicts();
                    callback?.Invoke();
                });
            });
    ...
    private void ProccessDicts()
    {
        ...
        {
            Debug.Log($"Checking key: '{hatSkin.title}'");
    ...
    {
        PlayFabController.Instance.SetHats(playerHatsDict);
